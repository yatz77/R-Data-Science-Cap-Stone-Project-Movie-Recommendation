...
# presurvey on the data

#number of distinct users
n_distinct(edx$userId)

#number of movie ratings in a particular genre
...
edx %>% group_by(title) %>% summarize(n = sum(ratings)) %>% arrange(desc(n))
edx %>% group_by(title) %>% summarize(n = n())  %>% arrange(desc(n))

# the top five most given ratings
